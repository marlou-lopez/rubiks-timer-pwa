  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className="relative flex-grow">
        <Listbox.Button className="relative flex h-8 w-48 items-center justify-between gap-1 rounded-md border bg-black px-3 py-1 text-sm text-white dark:bg-white dark:text-black">
